...
void retarget_init()
{
    ...
    //fix func priorities
    NT_COMMON_REG->GPIOPCTLD_bit.PIN11 = GPIO_AltFunc1;
    NT_COMMON_REG->GPIOPCTLE_bit.PIN0 = GPIO_AltFunc1;

    NT_COMMON_REG->GPIODEND = (1 << 11);
    NT_COMMON_REG->GPIODENE = 1;
    //NT_COMMON_REG->GPIOPCTLC_bit.PIN3 = GPIO_AltFunc2;
    //NT_COMMON_REG->GPIOPCTLC_bit.PIN4 = GPIO_AltFunc2;
    NT_GPIOD->ALTFUNCSET = (1 << 11);
    NT_GPIOE->ALTFUNCSET = 1;
